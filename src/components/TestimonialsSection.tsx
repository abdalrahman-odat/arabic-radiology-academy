...
const testimonials = [
  ...
  },
  {
    ...
    text: "أستاذ عبدالله من جد ما توفيك الكلمات حقك كورسال CT معك كان نقلة نوعية بالنسبة إلي درست المادة قبل بالجامعة وما كنت أستوعب منها أشي بس مع شرحك وطريقتك قدرت أفهم كل نقطة وكأني أول مرة أدرسها...أسلوبك جداً رهيب ويفتح النفس للمعلومة ممتنة إلك كثير والله",
    rating: 5,
  },
  {
    name: "محمد القحطاني",
