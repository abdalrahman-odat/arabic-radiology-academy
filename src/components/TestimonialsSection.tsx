...
const testimonials = [
  ...
  {
    name: "مريم الهاشمي",
    content: "دكتورنا العزيز، حابة أشكرك من قلبي على شرحك الرائع والمميز لمادة الـ CT 🌟بصراحة من أول محاضرة وأنا حاسة إن الماده بتكون سهلة وممتعة بفضلك، لأن أسلوبك في الشرح بسيط وواضح، وتوصل المعلومة بطريقة تخلي حتى الأمور الصعبة تنفهم بسهولة.شرحك ما كان ممل أبدًا، بالعكس كنا نستمتع بكل محاضرة ونتحمّس أكثر للمادة، وهذا الشي ما يصير إلا لما يكون المدرّس فعلاً مبدع ومخلص في شغله 👏كل كلمة تشرحها كانت تبين شكثر أنت حريص إننا نفهم ونتعلم صح، وفعلاً هذا الشي نقدّره كثير.",
    rating: 5,
  },
  {
    name: "أريام عادل",
