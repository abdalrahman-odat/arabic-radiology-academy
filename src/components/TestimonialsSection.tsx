...
const testimonials = [
  ...
  {
    name: "فرح",
    content: "إذا بتسمح اريد انطي رأيي عن الكورس ماشاء الله وانا من اول نا أطلقت الكورس كان ببالي اشترك بس ماصارت الفرصه وكان نصيبي بالنسخه الجديده من الكورس صراحه حلال بي كل فلس مدفوع ويستاهل أكثر والله من التصميم للشرح وكيف تتعب عليه والتزامك بالوقت واحترامك وتقديرك اله ماشاء الله وانا اصلا من زمان كنت ادور على احد يقدم الكورس بهاي الطريقه انت اجيت إنقاذ اقسم بالله صرت اعملك اعلان يم زملائي من كد ماعجبني الكورس وكنت ارجع للبيت قبل ربع ساعه من بداية المحاضره وكنت احاول احضرها اونلاين وبعدين ارجع للتسجيل اكتب كل الملاحظات الحمدلله الله على كلشي الله يكتب أجرنا الله يوفقك وتستاهل كل خير وان شاء الله بس اشتغل على جهاز CT راح اجي اوافيك بالاخبار وكيف الشغل",
    rating: 5,
  },
  {
    name: "يقين",
